...
# Eli Ritter, 8/12/2023,Modified code to complete assignment 06
# Bulk of additions added from Assignment05_Answer.py
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        # Code taken from the Assignment05_Answer.py file.
